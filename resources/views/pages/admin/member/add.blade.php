@section('htmlheader_title', 'Tambah Member')
...
<div class="container-fluid spark-screen">
	<div class="row">
		...
		<form action="{{ route('postAddMember') }}" method="POST">
		{{ csrf_field() }}
		<div class="col-md-12">
			<div class="box box-primary">
		      		...
		      		<div class="col-md-4">
		      			<table class="table table-bordered table-hover table-condensed table-striped">
		      				...
		      				<tbody>
		      					...
		      					<tr>
		      						<td>
		      							<input type="hidden" name="member_relations[{{ $i }}][id_perusahaan]" value="{{$perusahaan->id}}">
			      						<input type="text" name="member_relations[{{ $i }}][nama_perusahaan]" value="{{$perusahaan->nama_mlm}}" class="form-control text-uppercase" readonly="readonly">
		      						</td>
		      						<td>
		      							<input type="text" name="member_relations[{{ $i }}][id_member]" class="form-control text-uppercase">
		      						</td>
		      					</tr>
		      					@endforeach
		      				</tbody>
              ...
              <div class="box-footer">
              	...
              	<div class="form-group pull-right">
              		<button type="submit" class="btn btn-primary btn-flat"><i class="fa fa-plus"></i>  Tambah Member</button>
              	</div>
              </div>
            </div>
		</div>
